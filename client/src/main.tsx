...
function App() {
  ...
  return <div className="app-shell">
    ...
    <main>
      ...
      <div ref={chatRegion} id="mealwise-chat" hidden={!chatOpen}><ChatPanel budget={budget} dietary={dietary} onPlan={(response) => { setPlan(response.plan); setShowSavedOnly(false); }} /></div>
