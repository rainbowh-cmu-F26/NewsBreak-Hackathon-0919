...
import { fetchDefaultPlan, fetchPlan } from './api/plan';
...
function App() {
  ...
  return <div className="app-shell">
    ...
    <main>
      ...
      {chatOpen && <ChatPanel budget={budget} dietary={dietary} onPlan={(response) => { planRequestVersion.current += 1; setLoading(false); setError(''); setPlan(response.plan); setShowSavedOnly(false); window.requestAnimationFrame(() => document.getElementById('shortlist')?.scrollIntoView({ behavior: 'smooth', block: 'start' })); }} />}
